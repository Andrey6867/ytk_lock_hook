...
# Устанавливаем Anchor Version Manager (avm)
RUN cargo install --git https://github.com/coral-xyz/anchor avm --locked --force

# Запускаем установку Anchor внутри "login shell" для большей надежности
RUN bash -l -c "/home/gitpod/.cargo/bin/avm install latest && /home/gitpod/.cargo/bin/avm use latest"
